//
//  LeafAuthorization.swift
//  Leaf
//
//  Created by Elias Abel on 26/3/17.
//
//

import Foundation

public enum LeafAuthorization {
    case none, basic(user: String, password: String), bearer(token: String), custom(String)
}

extension LeafAuthorization: Equatable {}

extension LeafAuthorization: RawRepresentable {
