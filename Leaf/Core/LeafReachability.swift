...
public class LeafReachability {
    ...
    public static let shared = LeafReachability()
    ...
    @discardableResult public func start() -> Bool {
        ...
        let callbackEnabled = SCNetworkReachabilitySetCallback(reachability, { (_, flags, info) in
                let reachability = Unmanaged<LeafReachability>.fromOpaque(info!).takeUnretainedValue()
...
extension LeafReachability.Status: Equatable {

    public static func ==(lhs: LeafReachability.Status, rhs: LeafReachability.Status) -> Bool {
        switch (lhs, rhs) {
...
extension LeafReachability.Status: CustomStringConvertible {
...
extension LeafReachability.Status: CustomDebugStringConvertible {
...
extension LeafReachability.Connection: CustomStringConvertible {
...
extension LeafReachability.Connection: CustomDebugStringConvertible {
