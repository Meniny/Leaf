//
//  LeafServerTrust.swift
//  Leaf
//
//  Created by Elias Abel on 16/8/17.
//
//

import Foundation

/// The `LeafServerTrust` evaluates the server trust generally provided by an `NSURLAuthenticationChallenge` when
    ...
    public func evaluate(_ serverTrust: SecTrust, host: String) -> Bool {
        ...
        case let .pinPublicKeys(pinnedPublicKeys, validateCertificateChain, validateHost):
            ...
            if certificateChainEvaluationPassed {
                outerLoop: for serverPublicKey in LeafServerTrust.publicKeys(serverTrust) as [AnyObject] {
