//
//  LeafTransformer.swift
//  Leaf
//
//  Created by Elias Abel on 5/4/17.
//
//
...
class LeafTransformer {
    ...
    static func object<T>(object: Any?) throws -> T {
        ...
        throw LeafError.parse(code: underlying?._code, message: "The data couldn’t be transformed into \(T.self).", object: object, underlying: underlying)
    }
    ...
    static func decode<D: Decodable>(object: Any?) throws -> D {
        ...
        throw LeafError.parse(code: underlying?._code, message: "The data couldn’t be transformed into \(D.self).", object: object, underlying: underlying)
    }
